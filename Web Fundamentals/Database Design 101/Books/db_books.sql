...
--
-- Host: localhost
-- Generation Time: Mar 24, 2021 at 05:20 AM
...
ALTER TABLE `books_authors`
  ...
  ADD CONSTRAINT `books_authors_ibfk_2` FOREIGN KEY (`book_id`) REFERENCES `books` (`book_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `favorite_books`
  ...
  ADD CONSTRAINT `favorite_books_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
